...
import se.skaegg.discordbot.jpa.CommandStatisticsCountCommands;
import se.skaegg.discordbot.jpa.CommandStatisticsCountUsers;
import se.skaegg.discordbot.jpa.CommandStatisticsEntity;
import se.skaegg.discordbot.jpa.CommandStatisticsRepository;
...
public class CommandStatistics implements SlashCommand {
    ...
    public void addStatisticsToDb(ChatInputInteractionEvent event) {
        ...
        CommandStatisticsEntity commandStatistics = new CommandStatisticsEntity();
